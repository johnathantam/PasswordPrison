...
import "./ItemViewContent.css";

interface ItemViewContentProps {
    item: EncryptedVaultItem;
}

function ItemViewContent({ item }: ItemViewContentProps) {
        ...
        <div className="item-view-content">
            <div className="item-view-field">
                ...
                <div className="item-view-input-row">
                    <div
                        className="item-view-value item-view-value-ellipsis"
                        title={item.username}
                    >
                        {item.username}
                    </div>
            ...
            <div className="item-view-field">
                ...
                {isRequestingMasterKey && (
                    <div className="master-key-prompt">
            ...
            <div className="item-view-field">
                ...
                <div className="item-view-url-list">
                    {item.urls.map((url, index) => (
                        <div
                            key={index}
                            className="item-view-input-row"
                        >
                            <Globe
                                size={15}
                                className="item-view-url-icon"
                            />
