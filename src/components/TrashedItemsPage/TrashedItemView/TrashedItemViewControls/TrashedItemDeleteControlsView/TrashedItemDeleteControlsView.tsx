...
import "./TrashedItemDeleteControlsView.css";
...
interface TrashedItemDeleteControlsViewProps {
    item: EncryptedVaultItem;
    onRemove: (itemId: string) => void;
}

function TrashedItemDeleteControlsView({ item, onRemove }: TrashedItemDeleteControlsViewProps) {
    ...
    return (
        <div className="trashed-item-delete-controls-section">
            <button
                type="button"
                className="trashed-item-delete-control"
                onClick={() => {
            ...
            >
                <div className="trashed-item-delete-control-content">
                    <span className="trashed-item-delete-control-title">
                        Delete password
                    </span>

                    <span className="trashed-item-delete-control-description">
                        Permanently remove this password from your vault.
                    </span>
                </div>

                <span
                    className={`trashed-item-delete-control-arrow ${
            ...
            {deleteState === DeleteState.Confirmation && (
                <div className="trashed-item-delete-control-panel">
                    <div className="trashed-item-delete-confirmation">
                        <div className="trashed-item-delete-confirmation-content">
                        ...
                        <div className="trashed-item-delete-confirmation-actions">
                            <button
                                type="button"
                                className="trashed-item-delete-button-secondary"
                            ...
                            <button
                                type="button"
                                className="trashed-item-delete-button-danger"
            ...
            {deleteState === DeleteState.MasterKey && (
                <div className="trashed-item-delete-control-panel">
                    <div className="trashed-item-delete-master-key-header">
                    ...
                    <div className="trashed-item-delete-master-key-row">
                        <input
                            type="password"
                            ...
                            className="trashed-item-delete-master-key-input"
                            autoFocus
                            onKeyDown={(e) => {
                                if (e.key === "Enter") {
                                    deleteItem();
                    ...
                    {deleteMasterKeyInputError && (
                        <span className="trashed-item-delete-master-key-error">
                            {deleteMasterKeyInputError}
                        </span>
                    )}
                </div>
...
export { TrashedItemDeleteControlsView };