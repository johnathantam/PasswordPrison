...
import "./FavouriteItemViewContent.css";

interface FavouriteItemViewContentProps {
    item: EncryptedVaultItem;
}

function FavouriteItemViewContent({ item }: FavouriteItemViewContentProps) {
    ...
    return (
        <div className="favourite-item-view-content">

            <div className="favourite-item-view-field">
                <label>Category</label>

                <div className="favourite-item-view-value">
                    {item.category}
                </div>
            </div>
            ...
            <div className="favourite-item-view-field">
                ...
                <div className="favourite-item-view-input-row">
                    <div
                        className="favourite-item-view-value favourite-item-view-value-ellipsis"
                        title={item.username}
                    >
                        {item.username}
                    </div>
                    ...
                    <button
                        type="button"
                        className="favourite-item-view-input-icon-btn"
            ...
            <div className="favourite-item-view-field">
                ...
                {isRequestingMasterKey && (
                    <div className="favourite-master-key-prompt">
                        <div className="favourite-master-key-prompt-header">
                            <span>Enter Master Key</span>
                        </div>

                        <div className="favourite-master-key-prompt-row">
                            <input
                                type="password"
                                ...
                                className="favourite-form-input"
                                autoFocus
                                onKeyDown={(e) => {
                                    if (e.key === "Enter") {
                                        decryptItemPassword();
                            ...
                            <button
                                type="button"
                                className="favourite-btn-secondary"
                            ...
                            <button
                                type="button"
                                className="favourite-btn-primary"
                        ...
                        {masterKeyDecryptionError && (
                            <span className="favourite-form-helper favourite-form-helper-error">
                                {masterKeyDecryptionError}
                            </span>
                        )}
                    </div>
            ...
            <div className="favourite-item-view-field">
                ...
                <div className="favourite-item-view-url-list">
                    {item.urls.map((url, index) => (
                        <div
                            key={index}
                            className="favourite-item-view-input-row"
                        >
                            <Globe
                                size={15}
                                className="favourite-item-view-url-icon"
                            />
            ...
            {item.notes && (
                <div className="favourite-item-view-field">
                    ...
                    <div
                        className="favourite-item-view-notes"
                        title={item.notes}
                    >
                        {item.notes}
                    </div>
...
export { FavouriteItemViewContent };